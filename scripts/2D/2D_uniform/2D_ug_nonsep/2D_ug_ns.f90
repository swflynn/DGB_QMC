...
!==============================================================================!
!       Discussion:
!DGB analysis for 2D non-seperable potential (hard-coded)
...
!==============================================================================!
!       Discussion:
!c1,c2                  ==> Potential Energy Coefficients (hard-coded)
!==============================================================================!
...
double precision,allocatable::alpha(:),Tmat(:,:),Vmat(:,:),Hmat(:,:),points(:)
...
allocate(Tmat(NG,NG),Vmat(NG,NG),Hmat(NG,NG),r2(Dimen),points(NG_1D))
